...
module hstat_cori_g_const_kernel_mod
...
contains
  procedure, nopass :: hstat_cori_g_const_code
end type

!-------------------------------------------------------------------------------
! Contained functions/subroutines
!-------------------------------------------------------------------------------
public :: hstat_cori_g_const_code
...
end subroutine hstat_cori_g_const_code

end module hstat_cori_g_const_kernel_mod
